                            ...
                            if ("scroll" === P) {
                                ...
                                for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (_ = r(o).tweensContainer), d.each(b, function (t, e) {
                                    ...
                                    var E = y.Hooks.getRoot(O),
                                        W = !1;
                                    if (r(o).isSVG || "tween" === E || !1 !== y.Names.prefixCheck(E)[1] || y.Normalizations.registered[E] !== n) {
                                        (u.display !== n && null !== u.display && "none" !== u.display || u.visibility !== n && "hidden" !== u.visibility) && /opacity|filter/.test(O) && !B && 0 !== z && (B = 0), u._cacheValues && _ && _[O] ? (B === n && (B = _[O].endValue + _[O].unitType), W = r(o).rootPropertyValueCache[E]) : y.Hooks.registered[O] ? B === n ? (W = y.getPropertyValue(o, E), B = y.getPropertyValue(o, O, W)) : W = y.Hooks.templates[E][1] : B === n && (B = y.getPropertyValue(o, O));
                                        var H, j, q, Y = !1;
                                        if (B = (H = p(O, B))[0], q = H[1], z = (H = p(O, z))[0].replace(/^([+-\/*])=/, function (t, e) {
                                            ...
                                            if (0 === z) j = q;
                                                ...
                                                switch (q) {
                                                    case "%":
                                                        B *= "x" === U ? a.percentToPxWidth : a.percentToPxHeight;
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                                ...
                                                switch (j) {
                                                    case "%":
                                                        B *= 1 / ("x" === U ? a.percentToPxWidth : a.percentToPxHeight);
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                    ...
                                    } else v.debug && console.log("Skipping [" + E + "] due to a lack of browser support.")
                                }
                                c.element = o
                            }
            ...
            19: [function (t, e, i) {
                ...
                n._set("polarArea", {
                    ...
                    t.controllers.polarArea = t.DatasetController.extend({
                        ...
                        updateElement: function (t, e, i) {
                            for (var n = this, a = n.chart, o = n.getDataset(), s = a.options, l = s.animation, u = a.scale, d = a.data.labels, c = n.calculateCircumference(o.data[e]), h = u.xCenter, f = u.yCenter, p = 0, g = n.getMeta(), m = 0; m < e; ++m) isNaN(o.data[m]) || g.data[m].hidden || ++p;
                            var v = s.startAngle,
                ...
                e.exports = {
                    ...
                    update: function (t, e, i) {
                        if (t) {
                            ...
                            var z = l + O,
                                N = d + L;
                            n.each(h.concat(p), E), z += k, N += S, n.each(f, E), n.each(g, E), t.chartArea = {
                                left: I,
                                top: D,
                                right: I + k,
                                bottom: D + S
                            ...
                            if (a.display) {
                                ...
                                if (r.each(m, function (i, n) {
                                        if (!r.isNullOrUndef(i.label)) {
                                            var o, s, c, f, v, b, y, x, k, S, C, F, O, L, R = i.label;
                                            ...
                                            if (g) {
                                                ...
                                                E < e.left && (s = "rgba(0,0,0,0)"), E += r.aliasPixel(o), O = e.getPixelForTick(n) + d.labelOffset, v = y = k = C = E, b = _, x = D, S = t.top, F = t.bottom + A
                                            } else {
                                                var W, H = "left" === a.position;
                                                d.mirror ? (V = H ? "left" : "right", W = N) : (V = H ? "right" : "left", W = w + N), O = H ? e.right - W : e.left + W;
                                        ...
                                        if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), d.display) {
                                            ...
                                            var i = t.label;
                                            if (r.isArray(i))
                                                for (var n = i.length, a = 1.5 * b.size, o = e.isHorizontal() ? 0 : -a * (n - 1) / 2, l = 0; l < n; ++l) s.fillText("" + i[l], 0, o), o += a;
                                    ...
                                    var F, O, L = 0,
                                        R = o(f) / 2;
                                    if (g) F = e.left + (e.right - e.left) / 2, O = "bottom" === a.position ? e.bottom - R - C.bottom : e.top + R + C.top;
                                    else {
                                ...
                                if (h.drawBorder) {
                                    ...
                                    g ? (B = E = "top" === a.position ? e.bottom : e.top, B += W, E += W) : (z = N = "left" === a.position ? e.right : e.left, z += W, N += W), s.beginPath(), s.moveTo(z, B), s.lineTo(N, E), s.stroke()
                                }
                            }
                        }
                    })
            ...
            58: [function (t, e, i) {
                ...
                function m(t, e, i, a) {
                    ...
                    for (f || (f = function (t, e, i, n) {
                            ...
                            return o
                        }(t, e, c, i)), p && (b = b.isoWeekday(p), y = y.isoWeekday(p)), b = b.startOf(p ? "day" : c), (y = y.startOf(p ? "day" : c)) < e && y.add(1, c), o = n(b), m && h && !p && !d.round && (o.startOf(h), o.add(~~((b - o) / (v.size * f)) * f, c)); o < y; o.add(f, c)) x.push(+o);
                    return x.push(+o), x
                }
                e.exports = function (t) {
                    var e = t.Scale.extend({
                            ...
                            for (t = 0, i = (f.data.datasets || []).length; t < i; ++t)
                                if (f.isDatasetVisible(t))
                                    if (l = f.data.datasets[t].data, r.isObject(l[0]))
                                        for (x[t] = [], e = 0, a = l.length; e < a; ++e) u = p(l[e], h), y.push(u), x[t][e] = u;
                        ...
                        buildTicks: function () {
                            ...
                            for ("ticks" === s.bounds && c.length && (r = c[0], o = c[c.length - 1]), r = p(d.min, a) || r, o = p(d.max, a) || o, t = 0, e = c.length; t < e; ++t)(i = c[t]) >= r && i <= o && v.push(i);
                ...
                input: function (t) {
                    ...
                    if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
                        ...
                        var n = window.getComputedStyle(t, null),
                            a = n.color,
                            r = n.backgroundColor;
                        i.setAttribute("style", "color:" + a + ";background:" + r), t.setAttribute("style", "background-color:rgba(0,0,0,0);")
                    }
                },
                img: function (t) {
                    var e = t.parentNode;
...
var _this = void 0;
! function (t) {
    let e = `${["text","password","email","url","tel","number","search","search-md"].map(function(t){return`input[type=${t}]`}).join(", ")}, textarea`,
        i = function (t) {
